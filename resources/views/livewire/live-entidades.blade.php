...
<div class="flex flex-col">
                        ...
                        @foreach ($entidades as $value)
                            <tr
                                ...
                                <td class="px-3 py-1 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $value->municipio->provincia->prov_desc }}</div>
                                </td>
                                <td class="px-3 py-1 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $value->municipio->munic_desc }}</div>
                                </td>
                                <td class="px-3 py-1 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $value->entidad_desc }}</div>
                                </td>
    ...
    @if ($selected_id > 0)
        @include('energia.entidad_update')
    @else
        @include('energia.entidad_create')
    @endif
